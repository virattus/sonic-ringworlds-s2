#ifndef __FAKEYAUL_MENU_H__
#define __FAKEYAUL_MENU_H__
...
#define MENU_ACTION_ENTRY(_label, _action)	(menu_entry_t){\
	.label 			= _label,\
	.label_format 	= NULL,\
	.action_fn 		= _action,\
	.update_fn 		= NULL,\
...
#define MENU_CYCLE_ENTRY(_label_format, _cycle, _update)	(menu_entry_t){\
	.label 			= "",\
...
#define MENU_ACTION_CYCLE_ENTRY(_label_format, _action, _cycle, _update)	(menu_entry_t){\
	.label 			= "",\
	.label_format 	= _label_format,\
	.action_fn 		= _action,\
	.update_fn 		= _update,\
